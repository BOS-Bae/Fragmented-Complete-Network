...
int main(int argc, char *argv[]) {
	...
	vector<vector<int>> subsets_i = {{0,1,2},{3,4},{5}}; subsets_list.push_back(subsets_i);

	vector<vector<int>> subsets_1 = {{0},{1,2},{3,4},{5}}; subsets_list.push_back(subsets_1);
	vector<vector<int>> subsets_2 = {{0,3,4},{1,2},{5}}; subsets_list.push_back(subsets_2);
	vector<vector<int>> subsets_3 = {{0,1,2,3},{4},{5}}; subsets_list.push_back(subsets_3);
	vector<vector<int>> subsets_4 = {{0,1,2,3,4},{5}}; subsets_list.push_back(subsets_4);
	vector<vector<int>> subsets_5 = {{0,1,2},{3},{4},{5}}; subsets_list.push_back(subsets_5);
	vector<vector<int>> subsets_6 = {{0,1,3,4},{2},{5}}; subsets_list.push_back(subsets_6);
	vector<vector<int>> subsets_7 = {{0,1,2,4},{3},{5}}; subsets_list.push_back(subsets_7);
	vector<vector<int>> subsets_8 = {{0,3,4,5},{1,2}}; subsets_list.push_back(subsets_8);
	vector<vector<int>> subsets_9 = {{0,3,4},{1,2,5}}; subsets_list.push_back(subsets_9);
	vector<vector<int>> subsets_10 = {{0,1,2,3,4,5}}; subsets_list.push_back(subsets_10);
	vector<vector<int>> subsets_11 = {{0,1,2},{3,4,5}}; subsets_list.push_back(subsets_11);
	vector<vector<int>> subsets_12 = {{0,1,2,5},{3,4}}; subsets_list.push_back(subsets_12);
	vector<vector<int>> subsets_13 = {{0,5}, {1,2,3,4}}; subsets_list.push_back(subsets_13);
	vector<vector<int>> subsets_14 = {{0,5}, {1,2},{3,4}}; subsets_list.push_back(subsets_14);
	vector<vector<int>> subsets_15 = {{0,5}, {1,2},{3},{4}}; subsets_list.push_back(subsets_15);
	vector<vector<int>> subsets_16 = {{0,5}, {1,2,3,4}}; subsets_list.push_back(subsets_16);
	vector<vector<int>> subsets_17 = {{0}, {1,2,3,4}, {5}}; subsets_list.push_back(subsets_17);
	vector<vector<int>> subsets_18 = {{0,1,2}, {3,5}, {4}}; subsets_list.push_back(subsets_18);
	vector<vector<int>> subsets_19 = {{0}, {1,2,5}, {3,4}}; subsets_list.push_back(subsets_19);
	...
	for (int n_s=0; n_s<n_sample; n_s++){
		...
		else if (init_idx == 2) mat_i[3][4] *= -1;
		else if (init_idx == 3) mat_i[3][0] *= -1;
		else if (init_idx == 4) mat_i[0][5] *= -1;
		else if (init_idx == 5) mat_i[5][0] *= -1;
		else if (init_idx == 6) mat_i[3][5] *= -1;
		else if (init_idx == 7) mat_i[5][3] *= -1;
		else cout << "Error : set 'init_idx' to be within 0 ~ 7." << "\n";
