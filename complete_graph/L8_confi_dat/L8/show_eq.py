...
for k in range(0, n):
	for h in range(0,m):
		if (k==0 and h!=0 and h!=m-1):
			...
			print("q1{0}{1} == T13[{0}]*qp[{2}] + Op[{0},{1}]*q1{2}{1} + g1*qn[{4}] + Zm[{1}]*q1{0}{3} + (1-(T13[{0}] + Op[{0},{1}] + Zm[{1}] + g1))*q1{0}{1} &&".format(int(k),int(h),int(k+1),int(h-1), int(k+1)))
		elif (k==n-1 and h==m-1):
			print("q1{0}{1} == T13[{0}]*qp[{3}] + Om[{0}]*q1{2}{1} + Op[{0},{1}]*qp[{3}] + g1*qn[{5}] + Zm[{1}]*q1{0}{4} + (1-(T13[{0}] + Om[{0}] + Op[{0},{1}] + Zm[{1}] + g1))*q1{0}{1} &&".format(int(k),int(h),int(k-1),int(h+1),int(h-1), int(k+1)))
			...
			print("q1{0}{1} == T13[{0}]*qp[{3}] + Om[{0}]*q1{2}{1} + Op[{0},{1}]*q1{3}{1} + g1*qn[{3}] + Zm[{1}]*q1{0}{4} + (1-(T13[{0}] + Om[{0}] + Op[{0},{1}] + Zm[{1}]) + g1)*q1{0}{1} &&".format(int(k),int(h),int(k-1),int(k+1),int(h-1)))
		else: 			
...
for k in range(0, n):
	for h in range(0,m-1):
		if (k==0 and h!=0 and h!=m-2):
			...
			print("q2{0}{1} == T21[{1}]*q1{0}{1} + T23[{0}]*q3{0}{1} + Op[{0},{1}]*q2{2}{1} + Xp[{0},{1}]*qn[{4}] + Xm[{1}]*q2{0}{3} + (1-(T21[{1}] + T23[{0}] + Op[{0},{1}] + Xm[{1}] + Xp[{0},{1}]))*q2{0}{1} &&".format(int(k),int(h),int(k+1),int(h-1), int(k+1)))
		elif (k==n-1 and h==m-2):
			print("q2{0}{1} == T21[{1}]*q1{0}{1} + T23[{0}]*q3{0}{1} + Om[{0}]*q2{2}{1} + Op[{0},{1}]*qn[{3}] + Xp[{0},{1}]*qn[{4}] + Xm[{1}]*q2{0}{4} + (1-(T21[{1}] + T23[{0}] + Om[{0}] + Op[{0},{1}] + Xm[{1}] + Xp[{0},{1}]))*q2{0}{1} &&".format(int(k),int(h),int(k-1),int(h+1),int(h-1), int(k+1)))
		elif (h==0 and k!=0 and k!=n-1):
			...
			print("q2{0}{1} == T21[{1}]*q1{0}{1} + T13[{0}]*q3{0}{1} + Om[{0}]*q2{2}{1} + Op[{0},{1}]*q2{3}{1} + Xm[{1}]*q2{0}{4} + Xp[{0},{1}]*qn[{3}] + (1-(T21[{1}] + T23[{0}] + Om[{0}] + Op[{0},{1}] + Xm[{1}]))*q2{0}{1} &&".format(int(k),int(h),int(k-1),int(k+1),int(h-1)))
		else: 			
...
for k in range(0, n+1):
	for h in range(0,m-1):
		if (k==0 and h!=0 and h!=m-2):
			...
			print("q3{0}{1} == T31[{1}]*q1{0}{1} + T32[{0}]*q2{0}{1} + wp[{0},{1}]*qn[{4}] + Xp[{0},{1}]*qp[{4}] + Xm[{1}]*q3{0}{3} + Xp[{0},{1}]*qp[{2}]+ (1-(T31[{1}] + T32[{0}] + wp[{0},{1}] + Xm[{1}] + Xp[{0},{1}]))*q3{0}{1} &&".format(int(k),int(h),int(k+1),int(h-1), int(k+1)))

		elif (k==n and h==m-2):
			print("q3{0}{1} == T31[{1}]*qp[{3}] + wm[{0}]*q3{2}{1} + wp[{0},{1}]*qn[{3}] + Xp[{0},{1}]*qp[{5}] + Xm[{1}]*q3{0}{4} + (1-(T31[{1}] + wm[{0}] + wp[{0},{1}] + Xm[{1}] + Xp[{0},{1}]))*q3{0}{1},".format(int(k),int(h),int(k-1),int(h+1),int(h-1), int(k+1)))
			...
			print("q3{0}{1} == T31[{1}]*q1{0}{1} + T32[{0}]*q2{0}{1} + wm[{0}]*q3{2}{1} + wp[{0},{1}]*q3{3}{1} + Xm[{1}]*q3{0}{4} + Xp[{0},{1}]*qp[{3}]+ (1-(T21[{1}] + T23[{0}] + Om[{0}] + Op[{0},{1}] + Xp[{0},{1}] + Xm[{1}]))*q3{0}{1} &&".format(int(k),int(h),int(k-1),int(k+1),int(h-1)))
		else: 			
