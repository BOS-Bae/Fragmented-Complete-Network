...
plt.plot(x_arr, c_dist, label="L{}, numerical data".format(rule_num), marker = 'o', color='blue')
...
plt.figure(figsize=(10,3.5))
plt.plot(x_arr, cumul_dist, label="L{}, numerical data, F(m <= X)".format(rule_num), marker = 'o', color='blue')
